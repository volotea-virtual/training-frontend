const TwoToneColors = {
    ...
    warning: {
        backgroundColor: "bg-orange-50 dark:bg-orange-400",
        titleColor: "text-orange-700 dark:text-yellow-50",
        textColor: "text-orange-500 dark:text-yellow-50",
        iconColor: "text-orange-400 dark:text-yellow-50",
    },
    danger: {
